...
export default function Header({ theme = 1, sendData }) {
  ...
  return (
    <div className="container">
      {openPopup && (
        <CallPopup sendData={sendData} onClick={() => setOpenPopup(false)} />
      )}
      <div className={classNames(s.mobile, !open ? s.mobile__hide : "")}>
        <ul className={s.mobile__list}>
          <MobileItem href={"products"} title="Продукция"></MobileItem>
          <MobileItem href={"services"} title="Услуги"></MobileItem>
          <MobileItem href={"about"} title="О компании"></MobileItem>
          <MobileItem href={"coop"} title="Сотрудничество"></MobileItem>
          <MobileItem href={"delivery"} title="Оплата и доставка"></MobileItem>
      ...
      <header className={classNames(s.header, theme === 2 && s.header__theme)}>
          ...
          <div className={s.header__top}>
            <div className={s.logo}>
              ...
              <Link className={s.logo__link} href="/">
                <img className={s.logo__img} src="/images/logo.png" alt="" />
                <img
            ...
            <div className={s.tel}>
              ...
              <p onClick={() => setOpenPopup(!openPopup)}>Заказать звонок</p>
            </div>
          </div>
          <nav className={s.nav}>
                ...
                return (
                  <Link
                    ...
                    className={classNames(
                      s.nav__item,
                      s.nav__item__arrow,
                      pathname === item.href ? s.nav__item_active : ""
                    )}
