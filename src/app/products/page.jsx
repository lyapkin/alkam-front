    ...
    return (
        <>
            <Intro
                ...
                paths={["Продукция"]}
                text={
                    "Мы не просто принимаем заказы - мы развиваем партнерские отношения с нашими клиентами. Мы прислушиваемся к их меняющимся потребностям и находим решения, которые помогают им конкурировать на рынке."
                }
